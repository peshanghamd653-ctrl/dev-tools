...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            git_commands::git_conflict_sides,
            git_commands::git_resolve_ours,
            git_commands::git_resolve_theirs,
            git_commands::git_resolve_with_content,
            git_commands::git_rebase_start,
            git_commands::git_rebase_continue,
            git_commands::git_rebase_abort,
            git_commands::git_rebase_skip,
            git_commands::git_rebase_status,
            ...
            docker_commands::docker_compose_detect,
            docker_commands::docker_compose_status,
